...
I am partial to [Python](https://www.python.org/), especially since the release of multile R-like libraries, such as [polars](https://pola.rs/), [shiny](https://shiny.posit.co/py/) (equivalent to [`{shiny}`](https://shiny.posit.co/r/getstarted/shiny-basics/lesson1/)), [great tables](https://posit-dev.github.io/great-tables/) (equivalent to [`{gt}`](https://gt.rstudio.com/)), [plotnine](https://plotnine.org/) (equivalent to [`{ggplot2}`](https://ggplot2.tidyverse.org/)).
...
I primarily use the [RStudio IDE](https://posit.co/downloads/) or the [Positron IDE](https://positron.posit.co/)
...
- I try to follow Hadley Wickham's book [Tidy design principles](https://design.tidyverse.org/), which builds on the [Tidyverse style guide](https://style.tidyverse.org/), which in turn is derived from [Google’s R Style Guide](https://google.github.io/styleguide/Rguide.html).

- I use the [`{styler}`](https://styler.r-lib.org/) R package and RStudio add-in to re-style existing code with a single click. 

## Writing

- I am fluent in [LaTeX](https://www.latex-project.org/) but I would recommend [typst](https://typst.app/) for beginners.
